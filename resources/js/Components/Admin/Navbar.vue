<template>
    <div class="sticky top-0 z-40">
            ...
            <div class="flex">
                ...
                <div class="flex items-center inline-block mr-4 lg:hidden">
                    <button class="hover:text-blue-500 hover:border-white focus:outline-none navbar-burger"
                        @click="toggleSidebar()">
                        <svg class="w-5 h-5" v-bind:style="{ fill: 'black' }" viewBox="0 0 20 20"
        ...
        <!-- dropdown menu -->
        <div class="absolute right-0 w-48 mr-6 text-gray-700 bg-gray-100 border border-t-0 rounded-b-lg shadow-xl bottom-10"
