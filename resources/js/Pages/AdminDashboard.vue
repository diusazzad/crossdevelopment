...
<template>
    <div id="home">
        ...
        <div class="items-center justify-between mb-6 lg:flex">
            ...
            <button
                class="px-6 py-2 font-semibold text-white bg-blue-500 rounded-lg shadow hover:bg-blue-600 focus:outline-none">View
                Logs</button>
        </div>
...
// import Dashboard from 'resources/js/Layouts/Admin/Dashboard.vue'
// import AuthenticatedLayout from '@/Layouts/Dashboard.vue';
export default {
    name: 'DashboardHome',
    // name: 'AdminDashboard',
